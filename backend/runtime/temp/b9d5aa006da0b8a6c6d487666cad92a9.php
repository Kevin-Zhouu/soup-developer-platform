<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"P:\Projects\phpRedisX\src\public/../application/admin\view\manage\new_app.html";i:1555059285;s:69:"P:\Projects\phpRedisX\src\application\admin\view\common\template.html";i:1555059366;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
  ...
  <div class="collapse navbar-collapse soup-navcontent" id="navbarSupportedContent" >
	...
	<div class="soup-leftnav">
	  <ul class="nav flex-column nav nav-pills">
		...
		<li class="nav-item"> <a class="nav-link soup-nav-link active" href="newApp">新建应用</a> </li>
...
<div class="soup-bodycontent ">
	<div class="row">
		<div class="soup-bodyBlock soup-formBlock col shadow-sm bg-white">
			<h5 class="soup-el-pgtitle">新建应用</h5>
			<hr style="margin-top:0px">
			<form class="soup-el-pgcontent" method="post" action="newApp">
